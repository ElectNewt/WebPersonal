...
namespace WebPersonal.BackEnd.Model.Entity
{
    public class EducationEntity
    {
        ...
        public static EducationEntity UpdateId(int id, EducationEntity entity) =>
            new EducationEntity(id, entity.UserId, entity.StartDate, entity.EndDate, entity.CourseName, entity.CollegeName, entity.City, entity.Country);
    }
}
